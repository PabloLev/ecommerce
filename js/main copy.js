...
class Producto{
    constructor (id, categoria, genero, marca, modelo, talle, precio, cantidad, imagen){
        this.id = id;
        this.categoria = categoria; //Posibilidad de vender otro producto que no sean Productos y escalar a una especie de mercadolibre.
        this.genero = genero; //Se va a usar en un futuro para filtrar (Hombre, Mujer, Niño).
...
const productos = []; //Creo el array;
productos.push(new Producto("1", "calzado", "hombre",  "Topper", "x-force", "40", "1800", "3", "img/hombres/topper/topper_1a.webp"));
productos.push(new Producto("2", "calzado", "hombre", "New Balance", "ninja", "39", "3200", "10", "/img/NB-ninja.jpg"));
productos.push(new Producto("3", "calzado", "nino", "New Balance", "cebra", "41", "3600", "31", "/img/NB-cebra.jpg"));
productos.push(new Producto("4", "calzado", "mujer", "Puma", "gacele", "38", "2800", "5", "/img/Puma-gacele.jpg"));
productos.push(new Producto("5", "calzado", "hombre", "Nike", "infinity", "40", "3100", "1", "/img/Nike-infinity.jpg"));

console.log(productos);

// const calzado1 = new Producto("1", "calzado", "hombre",  "Topper", "x-force", "40", "1800", "3", "img/hombres/topper/topper_1a.webp");
// const calzado2 = new Producto("2", "calzado", "hombre", "New Balance", "ninja", "39", "3200", "10", "/img/NB-ninja.jpg");
// const calzado3 = new Producto("3", "calzado", "nino", "New Balance", "cebra", "41", "3600", "31", "/img/NB-cebra.jpg");
// const calzado4 = new Producto("4", "calzado", "mujer", "Puma", "gacele", "38", "2800", "5", "/img/Puma-gacele.jpg");
// const calzado5 = new Producto("5", "calzado", "hombre", "Nike", "infinity", "40", "3100", "1", "/img/Nike-infinity.jpg");
//END BASE SIMULADA//
