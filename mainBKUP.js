...
// products.push(new Product(1, 'calzado', 'man', 'Topper', 'classic', 'black', 1800, [{'size': 34, 'stock': 2},{'size': 35, 'stock': 0},{'size':36, 'stock':1}, {'size': 37, 'stock': 2}]));
// products.push(new Product(2, 'calzado', 'man', 'Topper', 'rainbow', 'multi', 1500, [{'size': 37, 'stock': 4},{'size': 40, 'stock': 5},{'size':99, 'stock':1}]));
// products.push(new Product(3, 'calzado', 'man', 'Topper', 'cebra', 'black_red', 2800, [{'size': 37, 'stock': 30},{'size': 30 , 'stock': 335},{'size':42, 'stock':0}]));
// products.push(new Product(4, 'calzado', 'man', 'Topper', 'lover', 'light-grey', 3100, [{'size': 10, 'stock': 3}]));
// products.push(new Product(5, 'calzado', 'man', 'Adidas', 'infinity', 'black', 5100, [{'size': 15, 'stock': 0}]));
// products.push(new Product(6, 'calzado', 'man', 'Adidas', 'js', 'black', 3100, [{'size': 39, 'stock': 0},{'size': 40, 'stock': 5},{'size':41, 'stock':1}]));
// products.push(new Product(7, 'calzado', 'man', 'Adidas', 'angular', 'black', 2100, [{'size': 35, 'stock': 3},{'size': 40, 'stock': 5}]));
// products.push(new Product(8, 'calzado', 'man', 'Adidas', 'rougue', 'black', 4200, [{'size': 16, 'stock': 9}]));
